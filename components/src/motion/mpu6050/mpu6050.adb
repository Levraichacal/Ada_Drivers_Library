...
--     end MPU6050_Configure_I2C;
   ...
   is
      ...
      type T_Uns8_Array_3 is array (1 .. 3) of Unsigned_8;
   ...
   begin
      ...
      MPU6050_Write_Byte_At_Register
   ...
   procedure MPU6050_Read_Byte_At_Register
     (Device   : MPU6050_Device;
      Reg_Addr : Byte;
      Data     : out Byte)
   is
   ...
   begin
      Device.Port.Mem_Read
        (Addr          => Device.Address,
         ...
         Status        => Status);
      Data := I_Data (1);
   end MPU6050_Read_Byte_At_Register;
   ...
   is
      Register_Value : Byte;
   begin
      MPU6050_Read_Byte_At_Register (Device, Reg_Addr, Register_Value);
   ...
   procedure MPU6050_Write_Byte_At_Register
     (Device   : MPU6050_Device;
      Reg_Addr : Byte;
      Data     : Byte)
   is
   ...
   begin
      Device.Port.Mem_Write
        (Addr          => Device.Address,
         ...
         Data          => (1 => Data),
         Status        => Status);
   end MPU6050_Write_Byte_At_Register;
   ...
   begin
      ...
      MPU6050_Write_Byte_At_Register (Device, Reg_Addr, Register_Value);
