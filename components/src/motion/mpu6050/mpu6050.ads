...
package MPU6050 is
   ...
   --  Types and subtypes
   type MPU6050_Device (Port        : HAL.I2C.I2C_Port_Ref;
                        I2C_AD0_Pin : MPU6050_AD0_Pin_State) is private;
...
private
   ...
   MPU6050_FT_ACC : constant array (1 .. 32) of Unsigned_16
     := (
   ...
   MPU6050_FT_GYR : constant array (1 .. 32) of Unsigned_16
     := (
   ...
   --  Read one byte at the specified MPU6050 register
   ...
   --  Write one byte at the specified MPU6050 register
